 ...
 */
@Stateless
@EJB(name = "java:app/RefDataAdminEJBLocal", beanInterface = RefDataAdminEJBLocal.class)
public class RefDataAdminEJB extends AbstractEJB implements RefDataAdminEJBLocal {
